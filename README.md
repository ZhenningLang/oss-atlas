...
| **Webnovel Writer** | Use it when a Claude Code serial novel needs chapters, facts, retrieval, reviews, and summaries to stay consistent over a long run. | GPL-3.0 | ? (0/6) | [EN](categories/agent-skills/writing/webnovel-writer.md) · [中](categories/agent-skills/writing/webnovel-writer.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **antfu/skills** | Anthony Fu's personal curated agent-skill collection for the Vue/Vite/Nuxt stack (his ESLint/pnpm/Vitest/UnoCSS prefs + generated/vendored framework skills), installed via the skills CLI. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/antfu-skills.md) · [中](categories/agent-skills/personal-collections/antfu-skills.zh.md) |
| **claude-code-harness** | A personal Claude Code harness that installs a governed plan → work → review → release loop (spec-first contracts, TDD-gated execution, independent review) as a plugin, with a Go-native doctor CLI for diagnosing plugin-cache and skill drift. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/claude-code-harness.md) · [中](categories/agent-skills/personal-collections/claude-code-harness.zh.md) |
| **dbskill** | A personal, curated pack of ~21 Chinese-language agent skills (/dbs-*) for business-model diagnosis, content creation, and personal decision-making, installable into Claude Code and other harnesses. | CC-BY-NC-4.0 | C (3/6) | [EN](categories/agent-skills/personal-collections/dbskill.md) · [中](categories/agent-skills/personal-collections/dbskill.zh.md) |
| **Dimillian Skills** | One developer's personal collection of 16 self-contained Codex skills, heavily focused on Apple-platform work (SwiftUI/iOS/macOS) plus generic review/refactor swarms. | MIT | C (4/6) | [EN](categories/agent-skills/personal-collections/dimillian-skills.md) · [中](categories/agent-skills/personal-collections/dimillian-skills.zh.md) |
| **gstack** | Garry Tan's personal Claude Code setup: ~23 opinionated slash-command skills that role-play a virtual engineering team (CEO review, designer, eng-manager, QA, security officer) across a plan-build-review-ship-retro loop. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/gstack.md) · [中](categories/agent-skills/personal-collections/gstack.zh.md) |
| **andrej-karpathy-skills** | A single behavioral-guidelines pack — one CLAUDE.md (plus a Cursor variant and a thin skills wrapper) distilling Karpathy's four LLM-coding principles (Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution) into Claude Code / Cursor. | MIT | C (4/6) | [EN](categories/agent-skills/personal-collections/karpathy-skills.md) · [中](categories/agent-skills/personal-collections/karpathy-skills.zh.md) |
| **Khazix Skills** | A small personal collection of five SKILL.md-format Agent Skills from 数字生命卡兹克 (Khazix) — disk cleanup, AI-news lookup, doc/memory reconciliation, long-form research reports, and WeChat-style writing — for SKILL.md-capable agents. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/khazix-skills.md) · [中](categories/agent-skills/personal-collections/khazix-skills.zh.md) |
| **ljg-skills** | Li Jigang's personal Claude Code skill collection (20+ skills) for Chinese knowledge work — reading, paper/book deconstruction, concept analysis, plain-language rewriting, and rendering content into visual PNG cards, installed via the skills CLI. | NOASSERTION | C (4/6) | [EN](categories/agent-skills/personal-collections/ljg-skills.md) · [中](categories/agent-skills/personal-collections/ljg-skills.zh.md) |
| **PUA** | A high-agency persona skill pack that frames your coding agent as a P8 engineer on a 30-day PIP, using corporate-PUA/PIP rhetoric to push it to exhaust debugging approaches instead of giving up early. | MIT | C (4/6) | [EN](categories/agent-skills/personal-collections/pua.md) · [中](categories/agent-skills/personal-collections/pua.zh.md) |
| **Qiushi-Skill** | A methodology skill pack arming a coding agent with "seek truth from facts" plus nine dialectical-materialist thinking tools (contradiction analysis, investigation-first, practice-cognition, etc.), installable across Claude Code/Cursor/Codex/OpenCode via an npx installer. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/qiushi-skill.md) · [中](categories/agent-skills/personal-collections/qiushi-skill.zh.md) |
| **shaping-skills** | Ryan Singer's personal Claude Code skill pack that brings Shape Up "shaping" — problem framing, breadboarding, and framing/kickoff docs — into your coding agent so the AI helps define what to build before any code is written. | NOASSERTION | D (4/6) | [EN](categories/agent-skills/personal-collections/shaping-skills.md) · [中](categories/agent-skills/personal-collections/shaping-skills.zh.md) |
| **TÂCHES CC Resources** | A personal, opinionated Claude Code bundle from TÂCHES (glittercowboy): ~27 slash commands, 9 skills (mostly meta-generators for building new commands/skills/subagents/hooks/MCP servers), 3 auditor subagents, and hooks — installable as one marketplace plugin. | MIT | C (4/6) | [EN](categories/agent-skills/personal-collections/taches-cc-resources.md) · [中](categories/agent-skills/personal-collections/taches-cc-resources.zh.md) |
| **skills** | Based on The Minimalist Entrepreneur by Sahil Lavingia | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/slavingia-skills.md) · [中](categories/agent-skills/engineering/slavingia-skills.zh.md) |
| **canghe-skills** | 苍何的技能skills仓库，搜集好用的 skills，辅助提效 | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/canghe-skills.md) · [中](categories/agent-skills/engineering/canghe-skills.zh.md) |
| **huashu-skills** | 花叔的内容创作 Skills 合集 - AI审校、选题生成、视频大纲、素材搜索等 11 个实用技能 | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/writing/huashu-skills.md) · [中](categories/agent-skills/writing/huashu-skills.zh.md) |
| **De-AI-Prompt-Enhancer-Writer-Booster-SKILL** | 去AI味提示词-作家增强-SKILL | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/de-ai-writing/de-ai-prompt-enhancer-writer-booster-skill.md) · [中](categories/agent-skills/de-ai-writing/de-ai-prompt-enhancer-writer-booster-skill.zh.md) |
...
| **writing-agent** | 🚀 一个基于 Claude Code (Skills + Subagents) 的“去AI味”全栈写作系统。不仅防套路，更通过专属规则强制注入人类观点与细节，搭配读者测试评估与自动图文排版。全面支持 DeepSeek / 智谱GLM / MiniMax 等国产低成本大模型，提供从选题、风格建模到审稿发布的高维全自动写作工作流。 | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/writing/writing-agent.md) · [中](categories/agent-skills/writing/writing-agent.zh.md) |
| **nuwa-skill** | 你想蒸馏的下一个员工，何必是同事。蒸馏任何人的思维方式——心智模型、决策启发式、表达DNA。Distill how anyone thinks. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/context-engineering/nuwa-skill.md) · [中](categories/agent-skills/context-engineering/nuwa-skill.zh.md) |
| **shuorenhua** | 说人话｜中文优先的去 AI 味改写 skill：保事实、分场景、改完可直接发。Chinese-first rewrite skill for Codex / Claude Code / Cursor / ChatGPT — removes AI tone, preserves facts. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/de-ai-writing/shuorenhua.md) · [中](categories/agent-skills/de-ai-writing/shuorenhua.zh.md) |
| **ai-flavor-remover** | AI 味去除 - 仅在 Gemini 2.5 Pro 上测试通过 | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/de-ai-writing/ai-flavor-remover.md) · [中](categories/agent-skills/de-ai-writing/ai-flavor-remover.zh.md) |
| **stop-slop** | A skill file for removing AI tells from prose | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/de-ai-writing/stop-slop.md) · [中](categories/agent-skills/de-ai-writing/stop-slop.zh.md) |
| **humanizer** | Claude Code skill that removes signs of AI-generated writing from text | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/de-ai-writing/humanizer.md) · [中](categories/agent-skills/de-ai-writing/humanizer.zh.md) |
| **cangjie-skill** | 把书、长视频、播客等高价值内容蒸馏成可执行的 Agent Skills | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/cangjie-skill.md) · [中](categories/agent-skills/engineering/cangjie-skill.zh.md) |
| **archify** | Any agent Skill: generate beautiful architecture diagrams with dark/light theme toggle and PNG/JPEG/WebP/SVG export | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/design/archify.md) · [中](categories/agent-skills/design/archify.zh.md) |
| **skills** | Skills for Real Engineers. Straight from my .claude directory. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/mattpocock-skills.md) · [中](categories/agent-skills/engineering/mattpocock-skills.zh.md) |
| **skills** | Browser automation CLI built for AI agents. Break through anti-bot walls, hand off to humans across platforms when stuck. Parallel multi-task execution, independent multi-session operation, isolated multi-account browsing. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/browser-act-skills.md) · [中](categories/agent-skills/engineering/browser-act-skills.zh.md) |
| **caveman** | 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/engineering/caveman.md) · [中](categories/agent-skills/engineering/caveman.zh.md) |
| **open-seo** | Open source alternative to Semrush and Ahrefs | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/design/open-seo.md) · [中](categories/agent-skills/design/open-seo.zh.md) |
| **ai-website-cloner-template** | Clone any website with one command using AI coding agents | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/design/ai-website-cloner-template.md) · [中](categories/agent-skills/design/ai-website-cloner-template.zh.md) |
| **huashu-design** | Huashu Design · HTML-native design skill for Claude Code · Claude Code 里 HTML 原生的设计 skill · 高保真原型 / 幻灯片 / 动画 + 20 设计哲学 + 5 维评审 + MP4 导出 · Agent-agnostic | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/writing/huashu-design.md) · [中](categories/agent-skills/writing/huashu-design.zh.md) |
| **ppt-master** | AI generates a real, editable PowerPoint from any document — native shapes & animations, editable charts & tables you can change the data on, speaker notes voiced as audio narration, and the option to follow your own .pptx template, not slide images · by Hugo He | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/slides-ppt/ppt-master.md) · [中](categories/agent-skills/slides-ppt/ppt-master.zh.md) |
| **frontend-slides** | Create beautiful slides on the web using a coding agent's frontend skills | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/slides-ppt/frontend-slides.md) · [中](categories/agent-skills/slides-ppt/frontend-slides.zh.md) |
| **html-ppt-skill** | HTML PPT Studio — AgentSkill with 24 themes, 31 layouts, 20+ animations for building professional HTML presentations | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/slides-ppt/html-ppt-skill.md) · [中](categories/agent-skills/slides-ppt/html-ppt-skill.zh.md) |
| **tacit-mining** | Let AI truly understand you. A Claude Code skill that extracts tacit knowledge through structured dialogue. 隐性知识挖掘技能。 | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/context-engineering/tacit-mining.md) · [中](categories/agent-skills/context-engineering/tacit-mining.zh.md) |
| **soul.md** | The best way to build a personality for your agent. Let Claude Code / OpenClaw ingest your data & build your AI soul. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/context-engineering/soul-md.md) · [中](categories/agent-skills/context-engineering/soul-md.zh.md) |
| **marketingskills** | Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analytics, and growth engineering. | NOASSERTION | ? (0/6) | [EN](categories/agent-skills/writing/marketingskills.md) · [中](categories/agent-skills/writing/marketingskills.zh.md) |
...
| **claude-video** | Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude. | NOASSERTION | ? (0/6) | [EN](categories/video-production/claude-video.md) · [中](categories/video-production/claude-video.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **agent-governance-toolkit** | AI Agent Governance Toolkit — Policy enforcement, zero-trust identity, execution sandboxing, and reliability engineering for autonomous AI agents. Covers 10/10 OWASP Agentic Top 10. | NOASSERTION | ? (0/6) | [EN](categories/governance/agent-governance-toolkit.md) · [中](categories/governance/agent-governance-toolkit.zh.md) |
