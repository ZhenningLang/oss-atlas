...
| **Claude Octopus** | You live in Claude Code and want other AI models to cross-review tasks for blindspots before shipping. | MIT | C (6/6) | [EN](categories/agent-frameworks/coding-agents/claude-octopus.md) · [中](categories/agent-frameworks/coding-agents/claude-octopus.zh.md) |
| **oh-my-claudecode** | You live in Claude Code and need staged multi-agent teams with model routing and tmux parallelism. | MIT | B (5/6) | [EN](categories/agent-frameworks/coding-agents/oh-my-claudecode.md) · [中](categories/agent-frameworks/coding-agents/oh-my-claudecode.zh.md) |
...
| **Kilo Code** | Use it when you want an open, BYOK in-IDE (VS Code) coding agent with planning and modes — an end-user tool, not a library to build agents. | MIT | B (6/6) | [EN](categories/agent-frameworks/coding-agents/kilocode.md) · [中](categories/agent-frameworks/coding-agents/kilocode.zh.md) |
...
| **Open Interpreter** | Use it when you want a Codex-fork terminal coding agent with swappable harnesses tuned for low-cost/open models (DeepSeek, Kimi, Qwen) — not the old Python REPL (that moved to a community fork), and it's a weeks-old 0.0.x rewrite that executes code. | Apache-2.0 | A (6/6) | [EN](categories/agent-frameworks/coding-agents/open-interpreter.md) · [中](categories/agent-frameworks/coding-agents/open-interpreter.zh.md) |
| **Codex** | Use it when you want a lightweight OpenAI-backed coding agent that runs in your terminal and can edit files, run tests, and commit changes — but it requires OpenAI API access and an internet connection. | Apache-2.0 | ? (0/6) | [EN](categories/agent-frameworks/coding-agents/codex.md) · [中](categories/agent-frameworks/coding-agents/codex.zh.md) |
...
| **CC Switch** | A cross-platform desktop manager for multiple AI coding agents with provider routing and MCP support — but it's under a year old with a single maintainer. | MIT | ? (0/6) | [EN](categories/agent-frameworks/coding-agents/cc-switch.md) · [中](categories/agent-frameworks/coding-agents/cc-switch.zh.md) |
...
| **OpenCode** | An open-source AI coding agent that runs in your terminal, edits files, and executes commands — but it's extremely young (created 2025-04) with no Lindy track record. | MIT | ? (0/6) | [EN](categories/agent-frameworks/coding-agents/opencode.md) · [中](categories/agent-frameworks/coding-agents/opencode.zh.md) |
