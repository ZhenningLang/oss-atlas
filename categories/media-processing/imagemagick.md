...
|---|---|---|---|
| [ffmpeg-python](ffmpeg-python.md) | ✅ | When you need the established in-index option for this category, compare it against ImageMagick before switching. | ImageMagick is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose ImageMagick only after verifying the repo-specific caveats below. |
...
| [ffsubsync](ffsubsync.md) | ✅ | When you need the established in-index option for this category, compare it against ImageMagick before switching. | ImageMagick is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose ImageMagick only after verifying the repo-specific caveats below. |
| [GStreamer](gstreamer.md) | ✅ | When you need the established in-index option for this category, compare it against ImageMagick before switching. | ImageMagick is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose ImageMagick only after verifying the repo-specific caveats below. |
