...
health:
  schema: 1
  computed_at: 2026-07-03T10:45:07Z
  overall: B
  overall_score: 2.75
  scored_axes: 4
  capped: false
...
| [Dimillian/Skills](dimillian-skills.zh.md)、[gstack](gstack.zh.md)、[ljg-skills](ljg-skills.zh.md)、[khazix-skills](khazix-skills.zh.md)、[taches-cc-resources](taches-cc-resources.zh.md) | ✅ | 更认同某位维护者的个人栈和工作习惯时，选对应个人集合。 | 同一类型——个人维护者精选的 skill/harness 捆绑——但各自反映不同人的栈和约定；按你真正认同谁的工具链与意见来比。 |
