...
health:
  schema: 1
  computed_at: 2026-07-03T10:46:55Z
  overall: A
  overall_score: 3.5
  scored_axes: 4
  capped: false
...
| [antfu/skills](../personal-collections/antfu-skills.md) | ✅ | Choose antfu/skills when the unit you need is task workflow skills, not role personas. | A personal *skills* collection (task workflows), not role personas — different unit of consumption. Use skills for "how to do X", personas for "act as Y". |
