...
tags: [agent-skill, engineering, slavingia-skills, skill-pack]
language: Unknown
license: NOASSERTION
...
health:
  schema: 1
  computed_at: 2026-07-16T08:05:33Z
  overall: C
  overall_score: 1.75
  scored_axes: 4
  capped: false
...
- **Maintenance snapshot (2026-07-16):** GitHub reports `archived=false` and `pushed_at=2026-04-14T00:53:57Z`.
- **Adoption snapshot:** ~9,583 GitHub stars as of 2026-07; this is a noisy signal and low-star projects are still included when the repository is real and relevant.
