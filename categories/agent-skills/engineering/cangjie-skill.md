...
tags: [agent-skill, engineering, cangjie-skill, skill-pack]
language: Python
license: NOASSERTION
maturity: active, ~3,177 stars (as of 2026-07)
...
health:
  schema: 1
  computed_at: 2026-07-16T08:11:30Z
  overall: B
  overall_score: 2.75
  scored_axes: 4
  capped: false
...
You're evaluating a task in the `engineering` area and want a real repository in the oss-atlas shortlist rather than an untracked name from a backlog. Reach for cangjie-skill when the upstream description matches the job, when its license and maintenance profile are acceptable after verification, and when adopting a public project is preferable to writing a local one-off.
...
- **Maintenance snapshot (2026-07-16):** GitHub reports `archived=false` and `pushed_at=2026-07-16T03:00:58Z`.
- **Adoption snapshot:** ~3,177 GitHub stars as of 2026-07; this is a noisy signal and low-star projects are still included when the repository is real and relevant.
