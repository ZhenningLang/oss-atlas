...
| 项目 | 何时用 | 健康度 | 页面 |
| --- | --- | --- | --- |
| **UI for Apache Kafka (provectus/kafka-ui)** | 当你想用一条 docker run 起一个浏览 Kafka broker、topic 和消费组 lag 的 Web 面板时用它——但 provectus 上游已停摆（末次发布 2024-04），应改用仍在维护的 kafbat/kafka-ui 分叉。 | C（4/6） | [→](kafka-ui.zh.md) |
...
| 选项 | 是否收录 | 健康度 | 一句话取舍 |
| --- | --- | --- | --- |
| [UI for Apache Kafka (provectus/kafka-ui)](kafka-ui.zh.md) | ✅ | C（4/6） | 当你想用一条 docker run 起一个浏览 Kafka broker、topic 和消费组 lag 的 Web 面板时用它——但 provectus 上游已停摆（末次发布 2024-04），应改用仍在维护的 kafbat/kafka-ui 分叉。 |
