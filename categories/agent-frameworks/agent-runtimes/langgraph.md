...
| [Hermes Agent](hermes-agent.md) | ✅ | When you need the established in-index option for this category, compare it against LangGraph before switching. | LangGraph is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose LangGraph only after verifying the repo-specific caveats below. |
| [OpenClaw](openclaw.md) | ✅ | When you need the established in-index option for this category, compare it against LangGraph before switching. | LangGraph is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose LangGraph only after verifying the repo-specific caveats below. |
