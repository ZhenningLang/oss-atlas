...
| [claude-octopus](../coding-agents/claude-octopus.md) | ✅ | Choose claude-octopus when you need a Claude-style multi-agent workflow sibling. | Sibling in this index, oriented around Claude-style multi-agent workflows; narrower model focus than AgentScope's multi-provider serving. |
