...
| [Hermes Agent](hermes-agent.md) | ✅ | When you need the established in-index option for this category, compare it against CrewAI before switching. | CrewAI is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose CrewAI only after verifying the repo-specific caveats below. |
| [OpenClaw](openclaw.md) | ✅ | When you need the established in-index option for this category, compare it against CrewAI before switching. | CrewAI is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose CrewAI only after verifying the repo-specific caveats below. |
| [OpenFang](openfang.md) | ✅ | When you need the established in-index option for this category, compare it against CrewAI before switching. | CrewAI is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose CrewAI only after verifying the repo-specific caveats below. |
