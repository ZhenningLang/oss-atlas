...
| [DSPy](dspy.zh.md) | ✅ | 需要对照指标编译/优化 LM 程序时，选 DSPy。 | *对照指标编译/优化* LM 程序；范式不同——smolagents 只跑一个「代码动作」循环，不优化提示词或权重。 |
...
- **响应速度**：Grade C——中位首次响应时间 236.0 小时，基于 25 个 qualifying issues/PRs。
