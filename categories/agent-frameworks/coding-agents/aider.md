...
|---|---|---|---|
| [CC Switch](cc-switch.md) | ✅ | When you need the established in-index option for this category, compare it against aider before switching. | aider is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose aider only after verifying the repo-specific caveats below. |
| [Claude Octopus](claude-octopus.md) | ✅ | When you need the established in-index option for this category, compare it against aider before switching. | aider is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose aider only after verifying the repo-specific caveats below. |
