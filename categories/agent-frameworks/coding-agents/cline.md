...
|---|---|---|---|
| [aider](aider.md) | ✅ | When you need the established in-index option for this category, compare it against Cline before switching. | Cline is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Cline only after verifying the repo-specific caveats below. |
| [CC Switch](cc-switch.md) | ✅ | When you need the established in-index option for this category, compare it against Cline before switching. | Cline is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Cline only after verifying the repo-specific caveats below. |
| [Claude Octopus](claude-octopus.md) | ✅ | When you need the established in-index option for this category, compare it against Cline before switching. | Cline is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Cline only after verifying the repo-specific caveats below. |
| [Codex](codex.md) | ✅ | When you need the established in-index option for this category, compare it against Cline before switching. | Cline is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Cline only after verifying the repo-specific caveats below. |
