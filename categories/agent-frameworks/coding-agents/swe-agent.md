...
| [Cline](cline.md) | ✅ | When you need the established in-index option for this category, compare it against SWE-agent before switching. | SWE-agent is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose SWE-agent only after verifying the repo-specific caveats below. |
