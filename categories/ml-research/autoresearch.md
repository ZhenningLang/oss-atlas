...
| nanoGPT | 未收录 | Choose nanoGPT when you need a minimal GPT training reference. | Minimal GPT training reference; pedagogical baseline you edit by hand, with no agentic-research framing or fixed-budget evaluation harness. |
