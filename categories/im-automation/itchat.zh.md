...
| 替代品 | 是否收录 | 我们的评价 | 取舍 |
|---|---|---|---|
| wechaty | 未收录 | 能接受 puppet 风险且需要维护中的多语言机器人框架时，选 wechaty。 | 维护活跃的多语言（TS/Python/Go/Java）对话机器人框架，采用可插拔的 "puppet"；是个人号风格微信机器人事实上的后继者，但仍依赖非官方 / 第三方接入通道，承担同样的 ToS / 封号风险——选 puppet 要谨慎。 |
