...
|---|---|---|---|
| [ClickHouse](clickhouse.md) | ✅ | When you need the established in-index option for this category, compare it against Debezium before switching. | Debezium is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Debezium only after verifying the repo-specific caveats below. |
...
| [DuckDB](duckdb.md) | ✅ | When you need the established in-index option for this category, compare it against Debezium before switching. | Debezium is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Debezium only after verifying the repo-specific caveats below. |
| [elasticsearch-dsl-py](elasticsearch-dsl-py.md) | ✅ | When you need the established in-index option for this category, compare it against Debezium before switching. | Debezium is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Debezium only after verifying the repo-specific caveats below. |
