...
|---|---|---|---|
| [ClickHouse](clickhouse.md) | ✅ | When you need the established in-index option for this category, compare it against DBeaver before switching. | DBeaver is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose DBeaver only after verifying the repo-specific caveats below. |
| [DuckDB](duckdb.md) | ✅ | When you need the established in-index option for this category, compare it against DBeaver before switching. | DBeaver is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose DBeaver only after verifying the repo-specific caveats below. |
