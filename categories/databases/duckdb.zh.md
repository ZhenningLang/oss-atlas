...
| 替代品 | 是否收录 | 我们的评价 | 取舍 |
|---|---|---|---|
| [elasticsearch-dsl-py](elasticsearch-dsl-py.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 DuckDB 对照。 | DuckDB 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
| [elasticsearch-sql](elasticsearch-sql.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 DuckDB 对照。 | DuckDB 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
| [go-mysql-elasticsearch](go-mysql-elasticsearch.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 DuckDB 对照。 | DuckDB 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
