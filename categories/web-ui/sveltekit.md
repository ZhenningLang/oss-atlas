...
| [Ant Design](ant-design.md) | ✅ | When you need the established in-index option for this category, compare it against SvelteKit before switching. | SvelteKit is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose SvelteKit only after verifying the repo-specific caveats below. |
| [Driver.js](driver-js.md) | ✅ | When you need the established in-index option for this category, compare it against SvelteKit before switching. | SvelteKit is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose SvelteKit only after verifying the repo-specific caveats below. |
| [Intro.js](intro-js.md) | ✅ | When you need the established in-index option for this category, compare it against SvelteKit before switching. | SvelteKit is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose SvelteKit only after verifying the repo-specific caveats below. |
