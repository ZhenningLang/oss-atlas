...
| [Svelte / SvelteKit](svelte.md) | ✅ | Choose Svelte when you want compile-time components with minimal runtime and no virtual DOM. | Svelte is faster and simpler for small-to-medium apps; React has a vastly larger ecosystem and hiring pool. |
