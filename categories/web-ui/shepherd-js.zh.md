...
| Reactour / react-joyride | 未收录 | 需要 React 专属的原生 hooks 或 JSX 引导组件时，选 Reactour / react-joyride。 | React 专属引导组件（hooks/JSX 原生）；在 React 内开发体验更好，但框架锁定，不如 Shepherd.js 的框架无关核心灵活。 |
