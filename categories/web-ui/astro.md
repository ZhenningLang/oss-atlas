...
| [Ant Design](ant-design.md) | ✅ | When you need the established in-index option for this category, compare it against Astro before switching. | Astro is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Astro only after verifying the repo-specific caveats below. |
| [Chakra UI](chakra-ui.md) | ✅ | When you need the established in-index option for this category, compare it against Astro before switching. | Astro is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Astro only after verifying the repo-specific caveats below. |
| [Driver.js](driver-js.md) | ✅ | When you need the established in-index option for this category, compare it against Astro before switching. | Astro is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Astro only after verifying the repo-specific caveats below. |
