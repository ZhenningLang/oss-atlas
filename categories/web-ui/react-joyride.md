...
health:
  schema: 1
  computed_at: 2026-07-06T16:01:10Z
  overall: B
  overall_score: 3.0
  scored_axes: 6
  capped: false
...
|---|---|---|---|
| [Angular](angular.md) | ✅ | When you need the established in-index option for this category, compare it against react-joyride before switching. | react-joyride is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose react-joyride only after verifying the repo-specific caveats below. |
| [Ant Design](ant-design.md) | ✅ | When you need the established in-index option for this category, compare it against react-joyride before switching. | react-joyride is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose react-joyride only after verifying the repo-specific caveats below. |
