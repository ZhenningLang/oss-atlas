...
|---|---|---|---|
| [Angular](angular.md) | ✅ | When you need the established in-index option for this category, compare it against Material UI (MUI) before switching. | Material UI (MUI) is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Material UI (MUI) only after verifying the repo-specific caveats below. |
...
| [Driver.js](driver-js.md) | ✅ | When you need the established in-index option for this category, compare it against Material UI (MUI) before switching. | Material UI (MUI) is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Material UI (MUI) only after verifying the repo-specific caveats below. |
| [Intro.js](intro-js.md) | ✅ | When you need the established in-index option for this category, compare it against Material UI (MUI) before switching. | Material UI (MUI) is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Material UI (MUI) only after verifying the repo-specific caveats below. |
