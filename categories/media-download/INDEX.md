...
| --- | --- | --- | --- |
| **youtube-dl** | Use it when you need a battle-tested CLI/library to download video & audio from YouTube and 1000+ sites — but prefer the active yt-dlp fork for hot sites. | B (5/6) | [→](youtube-dl.md) |
...
| --- | --- | --- | --- |
| [youtube-dl](youtube-dl.md) | ✅ | B (5/6) | Battle-tested extractor for 1000+ sites; upstream has slowed, so treat yt-dlp as the live fork for YouTube. |
