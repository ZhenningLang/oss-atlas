...
> Category node. Agent-driven generation of UI/design, slide decks, social cards, and HTML artifacts.
...
Tools and skill-packs whose job is to **generate visual / design artifacts** — UI, HTML, decks, illustrations, cards — with an agent. Not general agent frameworks; not code review.
