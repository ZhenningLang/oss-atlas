...
health:
  schema: 1
  computed_at: 2026-07-03T10:49:39Z
  overall: B
  overall_score: 2.67
  scored_axes: 6
  capped: false
...
| [guizang-ppt](guizang-ppt.md) | ✅ | Choose guizang-ppt when you need slide-deck generation as a skill-pack. | A skill-pack for slide-deck generation; narrow output type, no deterministic detector or CLI. Impeccable is broader frontend-quality tooling. |
| [guizang-social-card](guizang-social-card.md) | ✅ | Choose guizang-social-card when you need social-card generation as a skill-pack. | Skill-pack for social-card generation; single artifact type vs Impeccable's general UI linting. |
