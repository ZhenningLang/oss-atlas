...
| **Excalidraw** | 当你想要手绘风格的协作白板来画草图、线框和架构流程时用它——但它存为 JSON 而非纯文本，所以不能在 Git 里 diff。 | ?（0/6） | [→](excalidraw.zh.md) |
...
| [Excalidraw](excalidraw.zh.md) | ✅ | ?（0/6） | 手绘风格协作白板，用于画草图和线框；存为 JSON 而非纯文本，不能在 Git 里 diff。 |
