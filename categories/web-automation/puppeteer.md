...
|---|---|---|---|
| [Agent Browser](agent-browser.md) | ✅ | When you need the established in-index option for this category, compare it against Puppeteer before switching. | Puppeteer is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Puppeteer only after verifying the repo-specific caveats below. |
| [browser-use](browser-use.md) | ✅ | When you need the established in-index option for this category, compare it against Puppeteer before switching. | Puppeteer is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Puppeteer only after verifying the repo-specific caveats below. |
...
| [Cua](cua.md) | ✅ | When you need the established in-index option for this category, compare it against Puppeteer before switching. | Puppeteer is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Puppeteer only after verifying the repo-specific caveats below. |
