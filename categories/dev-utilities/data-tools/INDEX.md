...
| [ripgrep](ripgrep.md) | ✅ | ? (0/6) | Use it when you need a fast, smart, cross-platform search tool that respects gitignore by default and works identically on Windows, macOS, and Linux. |
