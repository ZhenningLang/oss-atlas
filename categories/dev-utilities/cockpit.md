...
health:
  schema: 1
  computed_at: 2026-07-03T11:22:17Z
  overall: D
  overall_score: 3.2
  scored_axes: 5
  capped: true
...
| [DevToys](devtoys.md) | ✅ | Choose DevToys when you need a developer's offline format/encode/convert toolbox on the desktop. | A developer's offline format/encode/convert toolbox on the desktop — unrelated problem; listed only because it shares this category, not a substitute. |
