...
| [Telegraf](telegraf.zh.md) | ✅ | 需要指标采集/路由 agent，而不是给人看的进度条时，选 Telegraf。 | 一个指标采集/路由 agent，不是进度条——完全不同的活；当你需要真正的遥测而非给人看的计量器时才用它。 |
...
- **响应速度**：Grade C——中位首次响应时间 511.3 小时，基于 2 个 qualifying issues/PRs。
