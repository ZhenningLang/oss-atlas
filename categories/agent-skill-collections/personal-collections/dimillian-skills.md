...
health:
  schema: 1
  computed_at: 2026-07-03T10:45:34Z
  overall: C
  overall_score: 2.25
  scored_axes: 4
  capped: false
...
| awesome-claude-code-subagents | 未收录 | Pick this directory when discovery of many Claude Code subagents matters more than one curated skill pack. | Curated Claude Code subagent directory; targets a different harness and is broader/shallower than this pack's Swift depth. |
